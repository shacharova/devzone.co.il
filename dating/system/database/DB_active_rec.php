...
class CI_DB_active_record extends CI_DB_driver {
    ...
    public function join($table, $cond, $type = '') {
        ...
        $join = $type . 'JOIN ' . $this->_protect_identifiers($table, TRUE,
                                                              NULL, FALSE) . ' ON ' . $cond;
    ...
    protected function _like($field, $match = '', $type = 'AND ', $side = 'both', $not = '') {
        ...
        foreach ($field as $k => $v) {
            ...
            if ($this->_like_escape_str != '') {
                $like_statement = $like_statement . sprintf($this->_like_escape_str,
    ...
    public function insert_batch($table = '', $set = NULL) {
        ...
        for ($i = 0, $total = count($this->ar_set); $i < $total; $i = $i + 100) {
            ...
            $sql = $this->_insert_batch($this->_protect_identifiers($table,
                                                                    TRUE, NULL,
                                                                    FALSE),
                                                                    $this->ar_keys,
                                                                    array_slice($this->ar_set,
                                                                                $i,
                                                                                100));
    ...
    function insert($table = '', $set = NULL) {
        ...
        $sql = $this->_insert($this->_protect_identifiers($table, TRUE, NULL,
                                                          FALSE),
    ...
    public function replace($table = '', $set = NULL) {
        ...
        $sql = $this->_replace($this->_protect_identifiers($table, TRUE, NULL,
                                                           FALSE),
                                                           array_keys($this->ar_set),
                                                                      array_values($this->ar_set));
    ...
    public function update($table = '', $set = NULL, $where = NULL, $limit = NULL) {
        ...
        $sql = $this->_update($this->_protect_identifiers($table, TRUE, NULL,
                                                          FALSE), $this->ar_set,
                                                          $this->ar_where,
                                                          $this->ar_orderby,
                                                          $this->ar_limit);
    ...
    public function update_batch($table = '', $set = NULL, $index = NULL) {
        ...
        // Batch this baby
        for ($i = 0, $total = count($this->ar_set); $i < $total; $i = $i + 100) {
            $sql = $this->_update_batch($this->_protect_identifiers($table,
                                                                    TRUE, NULL,
                                                                    FALSE),
                                                                    array_slice($this->ar_set,
                                                                                $i,
    ...
    protected function _merge_cache() {
        ...
        foreach ($this->ar_cache_exists as $val) {
            ...
            $this->$ar_variable = array_unique(array_merge($this->$ar_cache_var,
                                                           $this->$ar_variable));
        }
