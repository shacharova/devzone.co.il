    ...
    function _create_table($table, $fields, $primary_keys, $keys, $if_not_exists) {
        ...
        foreach ($fields as $field => $attributes) {
            ...
            if (is_numeric($field)) {
                ...
                if (in_array($field, $primary_keys) && array_key_exists('AUTO_INCREMENT',
                                                                        $attributes) && $attributes['AUTO_INCREMENT'] === TRUE) {
                    $sql .= ' SERIAL';
                } else {
                    $sql .= ' ' . $attributes['TYPE'];
                }
                ...
                if (array_key_exists('CONSTRAINT', $attributes) && strpos($attributes['TYPE'],
                                                                          'INT') === false) {
