...
class CI_Image_lib {
    ...
    function initialize($props = array()) {
        ...
        if ($this->new_image == '') {
            ...
            if (strpos($this->new_image, '/') === FALSE AND strpos($this->new_image,
                                                                   '\\') === FALSE) {
                $this->dest_folder = $this->source_folder;
    ...
    function rotate() {
        ...
        if ($this->rotation_angle == '' OR ! in_array($this->rotation_angle,
                                                      $degs)) {
    ...
    function image_process_gd($action = 'resize') {
        ...
        $copy($dst_img, $src_img, 0, 0, $this->x_axis, $this->y_axis,
              $this->width, $this->height, $this->orig_width, $this->orig_height);
    ...
    function overlay_watermark() {
        ...
        $this->wm_vrt_alignment = strtoupper(substr($this->wm_vrt_alignment, 0,
                                                    1));
        $this->wm_hor_alignment = strtoupper(substr($this->wm_hor_alignment, 0,
                                                    1));
