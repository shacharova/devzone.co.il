...
class CI_Email {
    ...
    public function attach($filename, $disposition = 'attachment') {
        ...
        $this->_attach_type[] = $this->_mime_types(pathinfo($filename,
                                                            PATHINFO_EXTENSION));
    ...
    protected function _prep_quoted_printable($str, $charlim = '') {
        ...
        foreach ($lines as $line) {
            ...
            for ($i = 0; $i < $length; $i++) {
                ...
                if ($i == ($length - 1)) {
                    $char = ($ascii == '32' OR $ascii == '9') ? $escape . sprintf('%02s',
                                                                                  dechex($ascii)) : $char;
                }
    ...
    protected function _prep_q_encoding($str, $from = FALSE) {
        ...
        $str = trim(preg_replace('/^(.*)$/m',
                                 ' =?' . $this->charset . '?Q?$1?=', $str));
    ...
    protected function _send_with_sendmail() {
        $fp = @popen($this->mailpath . " -oi -f " . $this->clean_email($this->_headers['From']) . " -t",
                                                                       'w');
    ...
    protected function _send_with_smtp() {
        ...
        $this->_send_data($this->_header_str . preg_replace('/^\./m', '..$1',
                                                            $this->_finalbody));
    ...
    protected function _set_error_message($msg, $val = '') {
        ...
        if (substr($msg, 0, 5) != 'lang:' || FALSE === ($line = $CI->lang->line(substr($msg,
                                                                                       5)))) {
